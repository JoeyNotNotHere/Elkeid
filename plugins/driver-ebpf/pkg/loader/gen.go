...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang -cflags "-O2 -g -Wall -Werror -D__TARGET_ARCH_x86" -target amd64,arm64 elkeid ../../bpf/elkeid.bpf.c -- -I../../bpf -I../../bpf/common
